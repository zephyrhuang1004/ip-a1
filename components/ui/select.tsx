...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-1.5 rounded-xl py-2 pr-8 pl-3 text-sm outline-hidden select-none focus:bg-[var(--item-focus-bg,var(--accent))] focus:text-accent-foreground data-highlighted:bg-[var(--item-focus-bg,var(--accent))] data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-1.5",
        className
      )}
      {...props}
    >
